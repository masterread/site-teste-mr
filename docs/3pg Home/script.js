...
document.addEventListener("DOMContentLoaded", function() {
  const servicosDropdown = document.getElementById("servicos-dropdown");
  const servicosSubmenu = document.getElementById("servicos-submenu");

  servicosDropdown.addEventListener("click", function(event) {
 ...
 // Função para abrir a notificação modal
function openNotificationModal() {
  document.getElementById('notificationModal').style.display = 'block';
}

// Função para fechar a notificação modal
function closeNotificationModal() {
  document.getElementById('notificationModal').style.display = 'none';
}

// Adiciona um evento de clique ao botão para abrir a notificação
document.getElementById('openNotificationBtn').addEventListener('click', openNotificationModal);

// Adiciona um evento de clique ao botão de fechar (X) para fechar a notificação
